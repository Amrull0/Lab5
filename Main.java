...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Введите значния x для y=3x+5: ");
        ...
        System.out.println("Результат: " + result3);
         ...
         static class Peremena {

             public static double peremena1(double x) {
                 return x * 3 + 5;
             }
             public static double peremena2 (double a, double b) {
                 if ( a == b){
                     System.out.println("Деление на ноль");
                 }
                 return (a + b) / ( a - b);
             }
             public static int peremena3 (int x, int a, int b) {
                 if (b == 0) {
                     System.out.println("Деление на ноль");
                 }
                 int y = 1;
